...
def extract(file_path):
    ...
    try:
        ...
        print(f"Extraction error: {file_path} was not found.")
        return []
    except json.JSONDecodeError as error:
        print(f"Extraction error: invalid JSON ({error}).")
        return []

    if not isinstance(data, list):
        print("Extraction error: source data must be a list of records.")
        return []

    print(f"Extraction complete. {len(data)} records extracted.")
    return data
